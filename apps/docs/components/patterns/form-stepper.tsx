...
const STEPS = [
  { id: "parties", label: "당사자", icon: Users },
  { id: "goods", label: "물품정보", icon: Package },
  { id: "transport", label: "운송", icon: Ship },
  { id: "valuation", label: "과세가격", icon: Calculator },
  { id: "docs", label: "첨부서류", icon: FileCheck },
] as const;
...
/* ---------------------------------------------------------------------------
 * StepIndicator — visual stepper bar
 * -------------------------------------------------------------------------*/
        ...
        {STEPS.map((step, index) => {
          ...
          return (
            ...
            >
              ...
              {index > 0 && (
                <div
                  className="absolute top-4 end-1/2 h-0.5 w-full -translate-y-1/2"
                  style={{ left: "-50%" }}
                >
                  <div
                    className={
                      completedSteps.has(index) || isCurrent
              ...
              <button
                ...
                aria-label={`${step.label} (${index + 1}단계)`}
...
/* ---------------------------------------------------------------------------
 * FormStepper — main exported component
 * -------------------------------------------------------------------------*/
...
export function FormStepper() {
  ...
  function goToStep(index: number) {
    ...
    // Mark the step we are leaving as completed (forward navigation)
  ...
  function handleStepClick(index: number) {
    // When clicking directly, mark all steps before target as completed
    setCompletedSteps((prev) => {
      const next = new Set(prev);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ----------------------------------------------------------------
       * Tabs (controlled by currentStep)
       * -------------------------------------------------------------- */}
      <Tabs
        value={currentStepId}
        onValueChange={(value) => {
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <Badge
                    variant="outline"
                    className="ms-auto border-emerald-300 text-emerald-700 dark:border-emerald-700 dark:text-emerald-400"
                  >
                    제출완료
                  </Badge>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Badge
                    variant="outline"
                    className="ms-auto border-red-300 text-red-700 dark:border-red-700 dark:text-red-400"
                  >
                    미제출
                  </Badge>
                </div>
